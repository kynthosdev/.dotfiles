...
# Export system and application defaults
export EDITOR='nvim'
export VISUAL='nvim'
export PAGER='most'
...
# Add $HOME bin locations to PATH
if [ -d "$HOME/.bin" ] ;
...
alias paru_upd="paru -Syu --noconfirm"
...
alias ninstfr="$EDITOR ~/.dotfiles/01_install_packages_from_repo.sh"
...
alias gc="git commit"
alias gd="git diff"
alias gpo="git push origin & gs"
alias gcpo="gc && gpo && gs"
