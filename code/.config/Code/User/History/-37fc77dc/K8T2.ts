...
const filePersister = MakeFilePersister({
  modelsDir: './pinia-orm-models/base-models/',
  enumsDir: './enums/',
...
const piniaOrmModelFiles = fastGlob.sync('./pinia-orm-models/base-models/*.ts')
...
modelNames.forEach((fileName) => {
  ...
  createEmptyFile(`./pinia-orm-models/models/${fileName}.ts`)
